...
export function meta() {
	return [{ title: 'Sign In | QuestBot' }, { name: 'description', content: 'Sign in to QuestBot Dashboard' }];
}
...
function DiscordIcon() {
	return (
		<svg width="48" height="40" viewBox="0 0 640 512" fill="white" aria-hidden="true">
